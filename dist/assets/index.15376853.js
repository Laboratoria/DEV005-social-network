...
const postsCollection = sh(db, "posts");
tf(postsCollection);
...
const paintPostsRealTime = (postsCallback) => {
  cf(dl(sh(db, "posts"), Il("date", "desc")), (querySnapshot) => {
    postsCallback(querySnapshot);
  });
};
const deletePost = (id2) => new Promise((resolve, reject) => {
  of(rh(wh(), "posts", id2)).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const editPost = (id2, newFields) => new Promise((resolve, reject) => {
  rf(rh(wh(), "posts", id2), newFields).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const aboutLikes = (id2, userId) => new Promise((resolve, reject) => {
  rf(rh(wh(), "posts", id2), { likes: Sf(userId) }).then((res) => resolve(res)).catch((error2) => reject(error2));
});
const aboutDislikes = (id2, userId) => new Promise((resolve, reject) => {
  rf(rh(wh(), "posts", id2), { likes: Df(userId) }).then((res) => resolve(res)).catch((error2) => reject(error2));
});
...
const iconEdit = "/assets/iconEdit.9af68564.svg";
const iconDelete = "/assets/iconDelete.6d697f62.svg";
const grayLike = "/assets/grayLike.425d7cdd.svg";
const redLike = "/assets/redLike.d6a3c064.svg";
const checkEdit = "/assets/checkEdit.19c1fccf.svg";
