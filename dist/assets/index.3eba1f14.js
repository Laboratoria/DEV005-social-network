...
function signup(navigateTo2) {
  ...
  nameTitle.textContent = "REG\xCDSTRATE";
...
const onGetPost = (callback) => cf(sh(db, "posts"), callback);
const deletePost = (id2) => of(rh(db, "posts", id2));
const getOnePost = (id2) => Jl(rh(db, "posts", id2));
const editPost = (id2, newFields) => rf(rh(db, "posts", id2), newFields);
const updateLike = (id2, uid) => rf(rh(db, "posts", id2), {
  likes: Sf(uid)
});
const removeLike = (id2, uid) => rf(rh(db, "posts", id2), {
  likes: Df(uid)
});
let id = "";
