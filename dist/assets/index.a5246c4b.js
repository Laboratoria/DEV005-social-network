...
function wall(navigateTo2) {
  ...
  aviso.textContent = "Pr\xF3ximamente aqu\xED estar\xE1n las publicaciones. Developers trabajando";
  const btnLogout = document.createElement("button");
  btnLogout.classList.add("btn-logout");
  btnLogout.textContent = "cerrar sesi\xF3n";
  btnLogout.addEventListener("click", navigateToLoginAfterLogout(navigateTo2));
