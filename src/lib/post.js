...
//   const likeArray = await arrayUnion(collection(db, 'posts'));
//   likeArray.forEach((doc) => {
//     console.log(doc.id, ' => ', doc.data());
//   });
};

// Función Firestore para quitar Like
export const dislikePost = (id) => arrayRemove(doc(db, 'posts', id));

// console.log('función dar like');

// try {
//   const postRef = collection(doc(db, 'posts', doc.id));
//   console.log(doc.id);
...
// /* eslint-disable no-console */
// import {
//   collection, addDoc, doc, deleteDoc, updateDoc, arrayUnion, arrayRemove, getDocs, query, onSnapshot,
// } from 'firebase/firestore';
// import { getAuth, onAuthStateChanged } from 'firebase/auth';
// import { async } from 'regenerator-runtime';
// import {
...
// // Función para eliminar un post de Firestore
// export const deletePostFromFirestore = async (post) => {
//   try {
...
//   try {
//     const postId = doc;
//     const postRef = collection(doc(db, 'posts'));
