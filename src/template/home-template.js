...
<div class="header-home">
    ...
    <button id="exitBtn" class="btn-exitys" ><ion-icon class="exitBtn" name="exit-outline"></ion-icon></button>  
</div>
...
<div class="backgraund-opacity hidden" id="backgraund-opacity">
    <div class="post-usuary">
        <div class="box-header-post">
            <button  id="btnClosePost" class="btn-close-post" ><ion-icon name="close-outline"></ion-icon></button> 
            <h3>create post</h3>
        </div>
        ...
        <div class="box-post">
            <form id="task-form" class="task-form">
                ...
                <p id="parrafo"><p>
                <button id="btn-task-save" class="task-save" >Post</<button>
            </form>
        </div>
    <div>
</div>
